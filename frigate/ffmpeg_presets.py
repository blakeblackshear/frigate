...
PRESETS_HW_ACCEL_DECODE = {
    ...
    "preset-intel-qsv-h264": f"-hwaccel qsv -hwaccel_device {_gpu_selector.get_selected_gpu()} -hwaccel_output_format qsv -c:v h264_qsv",
    "preset-intel-qsv-h265": f"-load_plugin hevc_hw -hwaccel qsv -hwaccel_device {_gpu_selector.get_selected_gpu()} -hwaccel_output_format qsv -c:v hevc_qsv",
