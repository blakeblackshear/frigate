...
export default function ReviewActionGroup({
  ...
  return (
    <div className="absolute inset-x-2 inset-y-0 md:left-auto md:right-2 p-2 flex gap-2 justify-between items-center">
      <div className="text-sm text-gray-500">{`${selectedReviews.length} selected | `}</div>
      <Button size="sm" variant="link" onClick={onClearSelected}>
        Unselect
      </Button>
