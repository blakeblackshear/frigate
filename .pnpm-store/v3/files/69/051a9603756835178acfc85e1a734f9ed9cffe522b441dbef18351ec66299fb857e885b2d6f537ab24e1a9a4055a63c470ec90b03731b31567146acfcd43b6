...
(function() {
  ...
  class Stacktrace {
    static create() {
      var _a3;
      const err = new Error();
      return new Stacktrace((_a3 = err.stack) != null ? _a3 : "");
    }
    constructor(value) {
      this.value = value;
    }
  ...
  class Emitter {
    constructor(options) {
      var _a3, _b2, _c3, _d2, _e, _f;
      this._size = 0;
      this._options = options;
      this._leakageMon = ((_a3 = this._options) == null ? void 0 : _a3.leakWarningThreshold) ? new LeakageMonitor((_b2 = options == null ? void 0 : options.onListenerError) != null ? _b2 : onUnexpectedError, (_d2 = (_c3 = this._options) == null ? void 0 : _c3.leakWarningThreshold) != null ? _d2 : _globalLeakWarningThreshold) : void 0;
    ...
    get event() {
      var _a3;
      (_a3 = this._event) != null ? _a3 : this._event = (callback, thisArgs, disposables) => {
        var _a4, _b2, _c3, _d2, _e, _f, _g, _h, _i;
        if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
          const message = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`;
          console.warn(message);
          const tuple = (_a4 = this._leakageMon.getMostFrequentStack()) != null ? _a4 : ["UNKNOWN stack", -1];
        ...
        if (!this._listeners) {
          (_d2 = (_c3 = this._options) == null ? void 0 : _c3.onWillAddFirstListener) == null ? void 0 : _d2.call(_c3, this);
    ...
    _removeListener(listener) {
      var _a3, _b2, _c3, _d2;
      (_b2 = (_a3 = this._options) == null ? void 0 : _a3.onWillRemoveListener) == null ? void 0 : _b2.call(_a3, this);
      if (!this._listeners) {
        return;
      }
      if (this._size === 1) {
  ...
  function lookupMessage(index, fallback) {
    var _a3;
    const message = (_a3 = getNLSMessages()) == null ? void 0 : _a3[index];
  ...
  } else if (typeof process !== "undefined" && typeof ((_a2 = process == null ? void 0 : process.versions) == null ? void 0 : _a2.node) === "string") {
    nodeProcess = process;
  }
  ...
  const _GraphemeBreakTree = class {
    static getInstance() {
  ...
  const _AmbiguousCharacters = class {
  ...
  const _InvisibleCharacters = class {
    static getRawData() {
  ...
  const _BasicInplaceReplace = class {
    constructor() {
  ...
  class URI$2 {
    ...
    static joinPath(uri, ...pathFragment) {
      ...
      if (isWindows && uri.scheme === "file") {
        newPath = URI$2.file(win32.join(uriToFsPath(uri, true), ...pathFragment)).path;
      } else {
    ...
    static revive(data) {
      ...
      if (!data) {
        return data;
      } else if (data instanceof URI$2) {
        return data;
      } else {
        const result = new Uri(data);
        result._formatted = (_a3 = data.external) != null ? _a3 : null;
  ...
  class TokenizationRegistry {
    ...
    registerFactory(languageId, factory) {
      var _a3;
      (_a3 = this._factories.get(languageId)) == null ? void 0 : _a3.dispose();
  ...
  ({
    [17]: localize(750, "array"),
    [16]: localize(751, "boolean"),
    [4]: localize(752, "class"),
    [13]: localize(753, "constant"),
    [8]: localize(754, "constructor"),
    [9]: localize(755, "enumeration"),
    [21]: localize(756, "enumeration member"),
    [23]: localize(757, "event"),
    [7]: localize(758, "field"),
    [0]: localize(759, "file"),
    [11]: localize(760, "function"),
    [10]: localize(761, "interface"),
    [19]: localize(762, "key"),
    [5]: localize(763, "method"),
    [1]: localize(764, "module"),
    [2]: localize(765, "namespace"),
    [20]: localize(766, "null"),
    [15]: localize(767, "number"),
    [18]: localize(768, "object"),
    [24]: localize(769, "operator"),
    [3]: localize(770, "package"),
    [6]: localize(771, "property"),
    [14]: localize(772, "string"),
    [22]: localize(773, "struct"),
    [25]: localize(774, "type parameter"),
    [12]: localize(775, "variable")
  });
  var SymbolKinds;
  ...
  const _FoldingRangeKind$1 = class {
    static fromValue(value) {
      switch (value) {
        case "comment":
          return _FoldingRangeKind$1.Comment;
        case "imports":
          return _FoldingRangeKind$1.Imports;
        case "region":
          return _FoldingRangeKind$1.Region;
      }
      return new _FoldingRangeKind$1(value);
    }
    constructor(value) {
      this.value = value;
    }
  };
  let FoldingRangeKind$1 = _FoldingRangeKind$1;
  (() => {
    _FoldingRangeKind$1.Comment = new _FoldingRangeKind$1("comment");
  })();
  (() => {
    _FoldingRangeKind$1.Imports = new _FoldingRangeKind$1("imports");
  })();
  (() => {
    _FoldingRangeKind$1.Region = new _FoldingRangeKind$1("region");
  })();
  ...
  const _ResourceMap = class {
    ...
    get(resource) {
      var _a3;
      return (_a3 = this.map.get(this.toKey(resource))) == null ? void 0 : _a3.value;
    }
    has(resource) {
  ...
  class DetailedLineRangeMapping extends LineRangeMapping {
    ...
    flip() {
      var _a3;
      return new DetailedLineRangeMapping(this.modified, this.original, (_a3 = this.innerChanges) == null ? void 0 : _a3.map((c) => c.flip()));
    }
  ...
  class LegacyLinesDiffComputer {
    computeDiff(originalLines, modifiedLines, options) {
      ...
      for (const c of result.changes) {
        ...
        let change = new DetailedLineRangeMapping(originalRange, modifiedRange, (_a3 = c.charChanges) == null ? void 0 : _a3.map((c2) => new RangeMapping(new Range$1(c2.originalStartLineNumber, c2.originalStartColumn, c2.originalEndLineNumber, c2.originalEndColumn), new Range$1(c2.modifiedStartLineNumber, c2.modifiedStartColumn, c2.modifiedEndLineNumber, c2.modifiedEndColumn))));
        if (lastChange) {
  ...
  const _LineRangeFragment = class {
    static getKey(chr) {
    ...
    computeSimilarity(other) {
      ...
      for (let i = 0; i < maxLength; i++) {
        sumDifferences += Math.abs(((_a3 = this.histogram[i]) != null ? _a3 : 0) - ((_b2 = other.histogram[i]) != null ? _b2 : 0));
      }
  ...
  class LinesSliceCharSequence {
    ...
    extendToFullLines(range) {
      var _a3, _b2;
      const start2 = (_a3 = findLastMonotonous(this.firstElementOffsetByLineIdx, (x) => x <= range.start)) != null ? _a3 : 0;
  ...
  const _Color$1 = class {
    static fromHex(hex) {
      return _Color$1.Format.CSS.parseHex(hex) || _Color$1.red;
    }
    static equals(a2, b) {
      if (!a2 && !b) {
        return true;
    ...
    getRelativeLuminance() {
      const R = _Color$1._relativeLuminanceForComponent(this.rgba.r);
      const G = _Color$1._relativeLuminanceForComponent(this.rgba.g);
      const B = _Color$1._relativeLuminanceForComponent(this.rgba.b);
    ...
    lighten(factor) {
      return new _Color$1(new HSLA(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * factor, this.hsla.a));
    }
    darken(factor) {
      return new _Color$1(new HSLA(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * factor, this.hsla.a));
    }
    transparent(factor) {
      ...
      return new _Color$1(new RGBA(r, g, b, a2 * factor));
    }
    isTransparent() {
    ...
    opposite() {
      return new _Color$1(new RGBA(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
    }
    mix(color, factor = 0.5) {
      ...
      return new _Color$1(new RGBA(r, g, b, a2));
    }
    makeOpaque(opaqueBackground) {
      ...
      const { r, g, b, a: a2 } = this.rgba;
      return new _Color$1(new RGBA(opaqueBackground.rgba.r - a2 * (opaqueBackground.rgba.r - r), opaqueBackground.rgba.g - a2 * (opaqueBackground.rgba.g - g), opaqueBackground.rgba.b - a2 * (opaqueBackground.rgba.b - b), 1));
    }
    toString() {
      if (!this._toString) {
        this._toString = _Color$1.Format.CSS.format(this);
      }
  ...
  let Color$1 = _Color$1;
  (() => {
    _Color$1.white = new _Color$1(new RGBA(255, 255, 255, 1));
  })();
  (() => {
    _Color$1.black = new _Color$1(new RGBA(0, 0, 0, 1));
  })();
  (() => {
    _Color$1.red = new _Color$1(new RGBA(255, 0, 0, 1));
  })();
  (() => {
    _Color$1.blue = new _Color$1(new RGBA(0, 0, 255, 1));
  })();
  (() => {
    _Color$1.green = new _Color$1(new RGBA(0, 255, 0, 1));
  })();
  (() => {
    _Color$1.cyan = new _Color$1(new RGBA(0, 255, 255, 1));
  })();
  (() => {
    _Color$1.lightgrey = new _Color$1(new RGBA(211, 211, 211, 1));
  })();
  (() => {
    _Color$1.transparent = new _Color$1(new RGBA(0, 0, 0, 0));
  })();
  (function(Color2) {
    (function(Format) {
      (function(CSS) {
        ...
        CSS.format = format2;
        function parse2(css) {
          var _a3, _b2, _c3, _d2, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n;
          if (css === "transparent") {
          ...
          if (css.startsWith("rgba(")) {
            ...
            const r = parseInt((_b2 = (_a3 = color.groups) == null ? void 0 : _a3.r) != null ? _b2 : "0");
            const g = parseInt((_d2 = (_c3 = color.groups) == null ? void 0 : _c3.g) != null ? _d2 : "0");
  ...
  function findSectionHeaders(model, options) {
    var _a3;
    let headers = [];
    if (options.findRegionSectionHeaders && ((_a3 = options.foldingRules) == null ? void 0 : _a3.markers)) {
  ...
  function collectMarkHeaders(model, options) {
    ...
    for (let startLine = 1; startLine <= endLineNumber; startLine += CHUNK_SIZE - MAX_SECTION_LINES) {
      ...
      while ((match = regex.exec(text)) !== null) {
        ...
        const text2 = (_b2 = ((_a3 = match.groups) != null ? _a3 : {})["label"]) != null ? _b2 : "";
        const hasSeparatorLine = ((_d2 = ((_c3 = match.groups) != null ? _c3 : {})["separator"]) != null ? _d2 : "") !== "";
        const sectionHeader = {
          range,
          text: text2,
          hasSeparatorLine,
  ...
  const _AsyncIterableProducer = class {
    ...
    static computeDiff(originalTextModel, modifiedTextModel, options, algorithm) {
      ...
      function getLineChanges(changes) {
        return changes.map((m) => {
          var _a3;
          return [m.original.startLineNumber, m.original.endLineNumberExclusive, m.modified.startLineNumber, m.modified.endLineNumberExclusive, (_a3 = m.innerChanges) == null ? void 0 : _a3.map((m2) => [
  ...
  function format$3(documentText, range, options) {
    ...
    if (options.insertSpaces) {
      indentValue = (_a3 = cachedSpaces[options.tabSize || 4]) != null ? _a3 : repeat(cachedSpaces[1], options.tabSize || 4);
    } else {
      indentValue = "	";
    }
  ...
  function t(...args) {
    ...
    if (typeof messageFromBundle === "string") {
      return format$1(messageFromBundle, formatArgs);
    }
    if (messageFromBundle.comment) {
      return format$1(messageFromBundle.message, formatArgs);
    }
    return format$1(message, formatArgs);
  }
  ...
  function format$1(template, values) {
    ...
    return template.replace(_format2Regexp, (match, group) => {
      var _a3;
      return (_a3 = values[group]) != null ? _a3 : match;
    });
  }
  const formats = {
    ...
    validate(textDocument, schema, severity = DiagnosticSeverity.Warning, schemaDraft) {
      if (this.root && schema) {
        ...
        return validationResult.problems.map((p) => {
          ...
          return Diagnostic.create(range, p.message, (_a3 = p.severity) != null ? _a3 : severity, p.code);
        });
      }
      return void 0;
    }
  ...
  function getSchemaDraft(schema, fallBack = SchemaDraft.v2020_12) {
    ...
    if (schemaId) {
      return (_a3 = schemaDraftFromId[schemaId]) != null ? _a3 : fallBack;
    }
    return fallBack;
  }
  function validate(n, schema, validationResult, matchingSchemas, context) {
    ...
    function _validateNode() {
      ...
      if (deprecationMessage || schema.deprecated) {
        ...
        let targetNode = ((_a3 = node.parent) == null ? void 0 : _a3.type) === "property" ? node.parent : node;
        validationResult.problems.push({
    ...
    function _validateNumberNode(node2) {
      ...
      function normalizeFloats(float) {
        ...
        return parts && {
          ...
          multiplier: (((_a3 = parts[2]) == null ? void 0 : _a3.length) || 0) - (parseInt(parts[3]) || 0)
        };
      }
  ...
  class JSONCompletion {
    ...
    doesSupportMarkdown() {
      ...
      if (!isDefined(this.supportsMarkdown)) {
        const documentationFormat = (_c3 = (_b2 = (_a3 = this.clientCapabilities.textDocument) == null ? void 0 : _a3.completion) == null ? void 0 : _b2.completionItem) == null ? void 0 : _c3.documentationFormat;
    ...
    doesSupportsCommitCharacters() {
      ...
      if (!isDefined(this.supportsCommitCharacters)) {
        this.labelDetailsSupport = (_c3 = (_b2 = (_a3 = this.clientCapabilities.textDocument) == null ? void 0 : _a3.completion) == null ? void 0 : _b2.completionItem) == null ? void 0 : _c3.commitCharactersSupport;
      }
    ...
    doesSupportsLabelDetails() {
      ...
      if (!isDefined(this.labelDetailsSupport)) {
        this.labelDetailsSupport = (_c3 = (_b2 = (_a3 = this.clientCapabilities.textDocument) == null ? void 0 : _a3.completion) == null ? void 0 : _b2.completionItem) == null ? void 0 : _c3.labelDetailsSupport;
      }
    ...
    (() => {
      ...
      class f2 {
        constructor(t4, e3, r2, n2, i2, o2 = false) {
          ...
          "object" == typeof t4 ? (this.scheme = t4.scheme || h, this.authority = t4.authority || h, this.path = t4.path || h, this.query = t4.query || h, this.fragment = t4.fragment || h) : (this.scheme = function(t5, e4) {
  ...
  class JSONSchemaService {
    ...
    getSchemaFromProperty(resource, document2) {
      var _a3, _b2;
      if (((_a3 = document2.root) == null ? void 0 : _a3.type) === "object") {
  ...
  function findLinks(document2, doc) {
    ...
    doc.visit((node) => {
      var _a3;
      if (node.type === "property" && node.keyNode.value === "$ref" && ((_a3 = node.valueNode) == null ? void 0 : _a3.type) === "string") {
  ...
  function getLanguageService(params) {
    ...
    return {
      configure: (settings) => {
        ...
        (_a3 = settings.schemas) == null ? void 0 : _a3.forEach(jsonSchemaService.registerExternalSchema.bind(jsonSchemaService));
