...
var _index5 = require("./_core/setDate.cjs");
...
function differenceInDays(laterDate, earlierDate, options) {
  ...
  (0, _index5.setDate)(
    laterDate_,
    (0, _index4.getDate)(laterDate_) - sign * difference,
  );
...
function compareLocalAsc(laterDate, earlierDate) {
  const diff =
    (0, _index6.getFullYear)(laterDate) -
      (0, _index6.getFullYear)(earlierDate) ||
    (0, _index3.getMonth)(laterDate) - (0, _index3.getMonth)(earlierDate) ||
    (0, _index4.getDate)(laterDate) - (0, _index4.getDate)(earlierDate) ||
